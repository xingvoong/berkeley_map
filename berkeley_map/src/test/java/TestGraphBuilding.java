...
public class TestGraphBuilding {
    ...
    public void testTime() {
        ...
        for (int i = 0; i < 1000; i++) {
            double lon = Math.random() * (MapServer.ROOT_LRLON - MapServer.ROOT_ULLON) + MapServer.ROOT_ULLON;
            double lat = Math.random() * (MapServer.ROOT_ULLAT - MapServer.ROOT_LRLAT) + MapServer.ROOT_LRLAT;
